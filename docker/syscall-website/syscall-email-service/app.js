// app.js - Syscall Email Service Logic
...
async function initPrice() {
    try {
        // ✅ FIX: Using correct method name 'getServicePrice'
...
btn.addEventListener('click', async () => {
    ...
    const senderName = senderNameInput.value || "Syscall Bot";
    ...
    try {
        ...
        // ✅ NOW SAFE: result.secret is defined
